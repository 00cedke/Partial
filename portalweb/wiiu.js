...
const streams = {
	latest: fs.createWriteStream(`${root}/latest.log`),
	success: fs.createWriteStream(`${root}/success.log`),
	error: fs.createWriteStream(`${root}/error.log`),
	warn: fs.createWriteStream(`${root}/warn.log`),
	info: fs.createWriteStream(`${root}/info.log`),
	audit: fs.createWriteStream(`${root}/audit.log`),
};
